...
<img src="/community.png" />
    <h4></h4>
    <p></p>
    <h4 className="text-center" id="quote" style="text-align: center;color: rgb(92,94,96);"><strong>&nbsp;"There is no power for change greater than a community discovering what it cares about."</strong></h4>
    ...
    <div className="d-block" style="height: 30px;">
        <div className="container" style="height: 30px;">
            <div className="row" style="height: 30px;">
                <div className="col-md-11 offset-md-1" style="height: 30px;">
                    <div></div>
                </div>
            </div>
        </div>
    ...
    <div className="row">
        <div className="col-md-4">
            <div>
                <p className="text-center"><span className="fa-stack fa-2x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="far fa-lightbulb fa-stack-1x fa-inverse"></i></span></p>
                <p className="lead text-center">Make decisions that directly affect you and your community.</p>
                <p className="text-center"><button className="btn btn-primary" type="button">Sign Up<i className="fa fa-chevron-right"></i></button></p>
            </div>
        </div>
        <div className="col-md-4">
            <div>
                <p className="text-center"><span className="fa-stack fa-2x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fas fa-fist-raised fa-stack-1x fa-inverse"></i></span></p>
                <p className="lead text-center">We have 16 on going projects that need to be voted on.</p>
                <p className="text-center"><button className="btn btn-primary" type="button">Read More<i className="fa fa-chevron-right"></i></button></p>
            </div>
        </div>
        <div className="col-md-4">
            <div>
                <p className="text-center"><span className="fa-stack fa-2x"><i className="fa fa-circle fa-stack-2x text-primary"></i><i className="fab fa-rocketchat fa-stack-1x fa-inverse"></i></span></p>
                <p className="lead text-center">Do you want to address an issue or simply get involved?</p>
                <p className="text-center"><button className="btn btn-primary" type="button">Chat <i className="fa fa-chevron-right"></i></button></p>
            </div>
        </div>
    </div>
</div>
    ...
    <div className="container">
        <p className="text-sm-left text-md-left d-md-flex flex-nowrap justify-content-md-center align-items-md-center"></p>
    </div>
    <div></div>
    <div></div>
    <div></div>
        ...
        <div className="row" id="project-row">
            ...
            <div className="col">
                <div className="row">
                    ...
                    <div className="col-lg-6 mb-4">
                        <div className="card text-white bg-danger shadow"></div>
                    </div>
                    <div className="col-lg-6 mb-4">
                        <div className="card text-white bg-secondary shadow"></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <div className="container">
          ...
          <div className="form-group">
            <div className="my-1">
              <div className="custom-control custom-checkbox mr-sm-2">
                ...
                <label className="custom-control-label" for="customControlAutosizing1">I have read and agree to the <a href="#" className="text-decoration-none">terms and conditions</a></label>
              </div>
            </div>
          </div>
        </form>
    ...
    <script id="bs-live-reload" data-sseport="49271" data-lastchange="1617860386976" src="/js/livereload.js"></script>
